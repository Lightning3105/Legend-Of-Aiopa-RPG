...
def newGame():
    ...
    entityClasses.Enemy(-100, -100, 1, "Resources/Images/Generic Goblin.png", {"Name": "Groblin Lvl. 1", "Health":5, "Attack":5})
    ...
    entityClasses.NPC((0, 30, "Down", 1), "Resources/Images/Male_Basic.png", {"Name":"Fred", "Conversation":cn})
