...
def game():
    ...
    cn = {"O1": {"Message": "hello there, how are you. This is a very long test message to check if this auto line return thing works.", "ID":1, "Next":{"Message": "Apparently it does. Have a very good day, sir.", "Goto":1, "End":True}}}
